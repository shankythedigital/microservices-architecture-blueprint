...
AUTH_PORT_LOCAL="${AUTH_PORT_LOCAL:-8081}"
NOTIF_PORT_LOCAL="${NOTIF_PORT_LOCAL:-8082}"
ASSET_PORT_LOCAL="${ASSET_PORT_LOCAL:-8085}"
HELPDESK_PORT_LOCAL="${HELPDESK_PORT_LOCAL:-8084}"
